...
export default function Settings() {
  ...
  const SelectSetting = ({ label, category, settingKey, value, options }) => (
    <div className="flex items-center justify-between py-3 border-b border-slate-100 last:border-0 flex-wrap gap-3">
      <p className="text-sm font-medium text-slate-900">{label}</p>
      <select
        value={value}
    ...
    <div className="max-w-5xl mx-auto space-y-6 px-4 sm:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Gérez vos préférences et options de la plateforme</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      {/* Messages */}
      {saveSuccess && (
        <div className="flex items-center gap-2 p-3 bg-emerald-50 text-emerald-700 rounded-xl">
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        ...
        {activeTab === 'compte' && (
          <div>
            <div className="p-5 border-b border-slate-100">
              <h3 className="font-semibold text-slate-900 mb-4">Préférences générales</h3>
              ...
              <SelectSetting label="Thème" category="compte" settingKey="theme" value={settings.compte.theme} options={[{ value: 'light', label: 'Clair' }, { value: 'dark', label: 'Sombre' }]} />
        ...
        {activeTab === 'confidentialite' && (
          <div className="p-5">
            <h3 className="font-semibold text-slate-900 mb-4">Visibilité</h3>
            ...
            <h3 className="font-semibold text-slate-900 mt-6 mb-4">Cas cliniques</h3>
        ...
        {activeTab === 'partage' && (
          <div className="p-5">
            <h3 className="font-semibold text-slate-900 mb-4">Options de partage</h3>
        ...
        {activeTab === 'affichage' && (
          <div className="p-5">
            <h3 className="font-semibold text-slate-900 mb-4">Préférences d'affichage</h3>
        ...
        {activeTab === 'notifications' && (
          <div className="p-5">
            <h3 className="font-semibold text-slate-900 mb-4">Types de notifications</h3>
        ...
        {activeTab === 'securite' && (
          <div className="divide-y divide-slate-100">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-3 py-2 pr-10 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${passwordErrors.currentPassword ? 'border-red-500' : 'border-slate-200'}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handlePasswordChange}
                        className={`w-full px-3 py-2 pr-10 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${passwordErrors.newPassword ? 'border-red-500' : 'border-slate-200'}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handlePasswordChange}
                        className={`w-full px-3 py-2 pr-10 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${passwordErrors.confirmPassword ? 'border-red-500' : 'border-slate-200'}`}
            ...
            {/* Sessions actives */}
            <div className="p-5">
              <h3 className="font-semibold text-slate-900 mb-4">Sessions actives</h3>
              <div className="space-y-3">
                {sessions.map((session) => (
                  <div key={session.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg flex-wrap gap-3">
            ...
            <div className="p-5">
              <h3 className="font-semibold text-slate-900 mb-4">Données</h3>
              <button onClick={handleExportData} className="w-full flex items-center justify-between p-3 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                <div className="flex items-center gap-3">
                  <Download className="w-4 h-4 text-blue-600" />
                  <div className="text-left">
                    <p className="text-sm font-medium text-slate-900">Exporter mes données</p>
                    <p className="text-xs text-slate-400">Télécharger toutes vos données personnelles</p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-slate-400" />
              </button>
              <button onClick={handleDeleteAccount} className="w-full flex items-center justify-between p-3 bg-red-50 rounded-lg hover:bg-red-100 transition-colors mt-3">
                <div className="flex items-center gap-3">
