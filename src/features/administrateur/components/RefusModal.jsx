        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              value={doctorName}
              readOnly
              className={`w-full px-3 py-2.5 text-sm rounded-xl border cursor-not-allowed ${
                dm
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className={`w-full appearance-none px-3 py-2.5 text-sm rounded-xl border transition-colors pr-10 focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-300 ${
                  dm
                    ? "bg-gray-800 border-gray-700 text-gray-300"
                    : motif
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Informations supplémentaires pour le médecin (démarches à suivre, corrections à apporter…)"
              className={`w-full px-3 py-2.5 text-sm rounded-xl border resize-none focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-red-300 transition-colors ${
                dm
        ...
        <div className={`px-6 py-4 border-t flex items-center justify-end gap-3 ${dm ? "border-gray-700" : "border-gray-100"}`}>
          <button
            ...
            className={`text-xs font-medium px-4 py-2 rounded-lg transition-colors ${
              dm ? "text-gray-400 hover:bg-gray-800 hover:text-gray-200" : "text-gray-500 hover:bg-gray-100 hover:text-gray-700"
            }`}
          >
            Annuler
          </button>
          <button
            ...
            className={`text-xs font-semibold px-4 py-2 rounded-lg transition-colors flex items-center gap-1.5 ${
              canSubmit
                ? "text-red-500 border border-red-200 hover:bg-red-50 dark:hover:bg-red-900/20"
                : dm
                ? "text-red-900 border border-red-900/30 cursor-not-allowed"
