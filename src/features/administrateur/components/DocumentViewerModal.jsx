    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="px-6 py-5">
          <div className={`rounded-xl border-2 border-dashed flex flex-col items-center justify-center gap-3 py-12 px-6 text-center ${
            dm ? "border-gray-700 bg-gray-800/40" : "border-teal-200 bg-teal-50/40"
          }`}>
            {/* Icône document */}
            ...
            <div>
              ...
              <p className={`text-xs mt-1 leading-relaxed max-w-xs ${dm ? "text-gray-500" : "text-gray-400"}`}>
                Aperçu du document — Dans l'application finale, le fichier s'affiche ici (PDF viewer ou image).
              </p>
            </div>

            {/* Actions */}
            <div className="flex items-center gap-3 mt-2">
              <button className="flex items-center gap-2 text-xs font-semibold text-white bg-teal-700 hover:bg-teal-800 px-4 py-2 rounded-lg transition-colors">
              ...
              <button
                ...
                className={`flex items-center gap-2 text-xs font-semibold px-4 py-2 rounded-lg transition-colors border ${
                  dm
                    ? "text-teal-400 border-teal-700 hover:bg-teal-900/30"
