...
export default function DossierModal({ doc, darkMode, onClose, onValidate, onRefuse }) {
  ...
  const [viewerDoc, setViewerDoc] = useState(null); // ← sous-modal visualisation
  ...
  return createPortal(
    <>
            ...
            <div className={`rounded-xl p-4 flex items-center gap-4 ${dm ? "bg-gray-800" : "bg-gray-50"}`}>
              ...
              <div>
                ...
                <p className="text-xs text-teal-500 mt-1">
                  ✓ Dossier {doc.docsStatus === "✓" ? "complet" : doc.docsStatus === "⚠" ? "incomplet" : "manquant"}
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {doc.documents.map((d, i) => (
                    ...
                    >
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={dm ? "text-gray-400" : "text-gray-400"}>
                      ...
                      {/* ✅ Bouton Visualiser → ouvre DocumentViewerModal */}
                      <button
                        onClick={(e) => { e.stopPropagation(); setViewerDoc(d.label); }}
              ...
              <div className={`rounded-xl border ${dm ? "border-gray-700" : "border-gray-100"}`}>
                <div className={`flex items-center justify-between px-4 py-3 border-b ${dm ? "border-gray-700 bg-gray-800/40" : "border-gray-100 bg-gray-50"}`}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {/* ✅ Bouton Ouvrir → ouvre DocumentViewerModal */}
                    <button
      ...
      {/* Sous-modal visualisation document */}
      {viewerDoc && (
        <DocumentViewerModal
