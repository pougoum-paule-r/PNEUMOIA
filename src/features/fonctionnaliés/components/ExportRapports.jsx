...
export default function ExportRapports() {
  ...
  const handleExport = (format) => {
    ...
    setTimeout(() => {
      setExporting(null);
      alert(`Rapport exporté au format ${format}`);
    }, 1500);
  };
                ...
                <div className="flex flex-wrap gap-2">
                  {report.formats.map((format, i) => (
                    <button
                      ...
                      className="px-3 py-1.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-blue-600 hover:text-white transition-all disabled:opacity-50"
                    >
