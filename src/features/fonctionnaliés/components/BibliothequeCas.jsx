...
export default function BibliothequeCas() {
  return (
    <section id="bibliotheque-cas" className="py-12 px-4 bg-gray-50 border-b border-gray-100">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            <p className="text-gray-600 leading-relaxed">
              Une bibliothèque collaborative de <span className="font-semibold text-gray-900">247 cas cliniques réels</span>, 
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Par pathologie, symptômes, ou mots-clés libres</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Âge, sexe, comorbidités, sévérité</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Chaque contribution est validée par le comité scientifique</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">pathologies couvertes</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-blue-600">80%</p>
                <p className="text-sm text-gray-500">concordance médecins/IA</p>
              </div>
              <div className="text-center">
