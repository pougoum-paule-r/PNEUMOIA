    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3">Témoignages</h2>
          ...
          {groupedTestimonials.length > 1 && (
            <>
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 lg:-ml-8 p-2 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-all border border-gray-200"
              >
                <ChevronLeft className="w-5 h-5 text-gray-600" />
              </button>
              <button
                onClick={nextTestimonial}
                className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 lg:-mr-8 p-2 bg-white rounded-full shadow-lg hover:bg-gray-50 transition-all border border-gray-200"
              >
