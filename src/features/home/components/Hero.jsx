...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section className="min-h-screen pt-20 sm:pt-24 px-4 sm:px-6 relative overflow-hidden">
        {/* Fond blanc pur */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-12 items-center min-h-[calc(100vh-5rem)] sm:min-h-[calc(100vh-6rem)]">
            ...
            >
              ...
              >
                ...
                <motion.button
                  ...
                  className="px-5 sm:px-6 py-2.5 sm:py-3 bg-white/80 backdrop-blur-sm border-2 border-blue-600 text-blue-700 rounded-xl hover:bg-blue-600 hover:text-white transition-all flex items-center justify-center gap-2 text-sm sm:text-base"
                >
                  Voir la démo
            ...
            <motion.div
              ...
              className="relative order-1 lg:order-2 w-full max-w-md sm:max-w-lg lg:max-w-none mx-auto"
            >
