        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">CLASSEMENT</h2>
            ...
            <div className="space-y-3">
              {rankings.map((item, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ x: 5 }}
                  className="flex items-center justify-between bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all border border-gray-100"
                >
          ...
          <div>
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">RÉPARTITION</h2>
              <h3 className="text-xl md:text-2xl font-semibold text-blue-600 mb-3">
            ...
            <div className="space-y-3">
              {repartition.map((item, idx) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl p-4 flex justify-between items-center cursor-pointer hover:shadow-md transition-all border border-gray-100"
                >
                  <div className="flex items-center gap-3">
