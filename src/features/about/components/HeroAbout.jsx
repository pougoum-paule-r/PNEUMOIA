      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-blue-600 font-semibold text-xl uppercase tracking-wider">
              À propos
            </span>
            <div className="w-8 h-px bg-blue-400"></div>
          </motion.div>
          ...
          {/* Grand titre noir et bleu */}
            <motion.h1
                ...
                className="text-2xl md:text-4xl lg:text-5xl font-semibold text-gray-700 mb-6"
              >
                Nous sommes là pour{" "}
                <span className="block text-blue-600">vous guider vers la</span>
          ...
          <motion.p
            ...
            className="text-base md:text-sm text-gray-600 leading-relaxed text-center"
          >
