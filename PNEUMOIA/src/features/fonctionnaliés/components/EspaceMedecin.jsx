              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Retrouvez tous vos diagnostics et analyses passées</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Sauvegardez les cas cliniques les plus pertinents</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Alertes sur les nouveaux cas, commentaires, et mises à jour</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Préférences d'affichage, notifications, et confidentialité</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500">Cas favoris</p>
                </div>
                <div className="text-center">
