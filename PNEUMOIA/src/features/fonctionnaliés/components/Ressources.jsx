      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {resources.map((res, idx) => (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mb-4">Niveau : {res.level}</p>
        ...
        <div className="bg-gray-50 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-800">Formations à venir</h3>
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between py-2 border-b border-gray-200 last:border-0">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-500">{formation.date}</span>
