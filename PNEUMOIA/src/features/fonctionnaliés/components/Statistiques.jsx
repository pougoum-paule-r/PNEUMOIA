          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Évolution mensuelle</p>
                    <p className="text-sm text-gray-500">Suivez le nombre de diagnostics par mois</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Répartition par pathologie</p>
                    <p className="text-sm text-gray-500">Visualisez les pathologies les plus fréquentes</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Performance IA</p>
                    <p className="text-sm text-gray-500">Taux de concordance entre vos diagnostics et l'IA</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">Historique détaillé</p>
                    <p className="text-sm text-gray-500">Exportez vos données pour analyse externe</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="font-semibold text-gray-800">Aperçu mensuel</h3>
                ...
                {[
                  ...
                  <div key={i}>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span className="font-medium text-gray-800">{item.value}{item.label === "Concordance IA" ? "%" : item.label === "Temps moyen (sec)" ? "s" : ""}</span>
                    </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm font-medium text-gray-700 mb-3">Pathologies les plus fréquentes</p>
                  ...
                  {[
                    ...
                    <div key={i}>
                      <div className="flex justify-between text-xs mb-1">
                        ...
                        <span className="text-gray-500">{path.count} cas ({path.percent}%)</span>
                      </div>
