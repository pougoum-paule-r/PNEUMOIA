...
export default function HeroFeatures() {
  ...
  return (
    <section className="pt-32 pb-12 px-4 bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <motion.div
              ...
              className="flex flex-wrap gap-4 mt-8 pt-4 border-t border-gray-100"
            >
